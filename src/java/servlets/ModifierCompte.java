            ...
            if (cliListe.size() > 0) {
                ...
                if (listeCpt.size() > 0) {
                    ...
                    if (AccountDao.researchOwnerId(cpt.getId()) == cli.getId()) {
                        ...
                        out.println("</td>");
                        out.println("<td>");
                        out.println("<input type=\"text\" name=\"nom\" id=\"nom\" value=\"" + cpt.getName() + "\" required readonly=\"readonly\"/>");
                        out.println("</td>");
                        out.println("</tr>");
                        out.println("<tr>");
                        out.println("<td>");
                        ...
                        out.println("</td>");
                        out.println("<td>");
                        out.println("<input type=\"text\" name=\"solde\" id=\"solde\" value=\"" + cpt.getBalance() + "\" required readonly=\"readonly\"/>");
                        out.println("</td>");
                        out.println("</tr>");
                        out.println("<tr>");
                        out.println("<td>");
